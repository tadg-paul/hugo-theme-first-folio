...
# ABOUTME: RT-83.12 - alphabetical and count sorting expose different expected orders.
...
#   Alphabetical and count sorting expose different expected orders.

# shellcheck source=_helpers.sh
source "$(dirname "${BASH_SOURCE[0]}")/_helpers.sh"

run_test() {
    run_tagcloud_case "83.12"
}
