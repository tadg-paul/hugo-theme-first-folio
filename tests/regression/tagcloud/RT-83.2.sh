...
# ABOUTME: RT-83.2 - an explicit false enable key suppresses shortcode output and styling.
...
#   An explicit false enable key suppresses shortcode output and styling.

# shellcheck source=_helpers.sh
source "$(dirname "${BASH_SOURCE[0]}")/_helpers.sh"

run_test() {
    run_tagcloud_case "83.2"
}
